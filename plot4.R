...
par(mfcol = c(2, 2))
plot(as.POSIXct(paste(coll_data$Date,coll_data$Time)),coll_data$Global_active_power,type = "l",xlab = "",ylab = "Global Active Power (kilowatts)")
...
plot(as.POSIXct(paste(coll_data$Date,coll_data$Time)),coll_data$Voltage,type = "l",xlab = "datetime",ylab = "Voltage")

plot(as.POSIXct(paste(coll_data$Date,coll_data$Time)),coll_data$Global_reactive_power,type = "l",xlab = "datetime",ylab = "Global_Reactive_Power")
